  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Easily get random formations and positions on Fifa"
        />
        <meta
          name="keywords"
          content="FIFA, Pro Clubs, Formations, Positions, Random, Next.js, App, fifa, jed, jed patterson"
        />
        ...
        <meta
          ...
          content="Easily create random FIFA Pro Clubs formations and positions for you and your friends."
        />
